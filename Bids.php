...
<body class="fix-header">
    ...
    <div id="wrapper">
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">BIDS</h4> </div>
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        <button class="right-side-toggle waves-effect waves-light btn-info btn-circle pull-right m-l-20"><i class="ti-settings text-white"></i></button>
                        
                    <ol class="breadcrumb">
                            <li><a href="dashboard.php">BIDS</a></li>
                            <
                        </ol>
                </div>
                <!-- /.row -->
     ...
     <div class="col-md-9 col-lg-9 col-sm-12">
                        <div class="panel">
                            <div class="panel-heading">MANAGE BIDS</div>
                            <div class="table-responsive">
                                <table class="table table-hover manage-u-table">
                                    <thead>
                                        <tr>
                                            <th style="width: 70px;" class="text-center">GIG_ID</th>
                                             <th>BUYER_ID</th>
                                            <th>BUER_NAME</th>
                                            <th>GIG_DESCRIPTION</th>
                                            <th>MANAGE</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                    <?php
                $sql='select * from tbl_gig';
                $res=$conn->query($sql);
               while($rec=$res->fetch_array()){
                ...
                ?>
                                        ...
                                        <tr>
                                            <td class="text-center"><?=$GIG_ID?></td>
                                            <td><span class="font-medium"></span>
                                                <span class="text-muted"><?=$BUYER_ID?></span></td>
                                           
                                     <td><span class="text-muted"><?=$BUER_NAME?></span></td>
                                            <td>
                                                <span class="text-muted"><?=$GIG_DESCRIPTION?></span></td>
